...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      // z-[100] ensures overlay is above sidebar (z-[60]) and other UI elements
...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // z-[100] ensures content is above sidebar (z-[60]) and other UI elements
        // Base styles
        "fixed z-[100] grid gap-4 border bg-background shadow-2xl duration-200",
