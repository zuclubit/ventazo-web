...
const variantConfig: Record<LogoVariant, { text: string; glow: string }> = {
  default: {
    ...
    glow: 'bg-ventazo-500/40 group-hover:bg-ventazo-400/50',
  },
  light: {
    text: 'text-white group-hover:text-ventazo-100',
    glow: 'bg-ventazo-500/40 group-hover:bg-ventazo-400/50',
  },
  dark: {
    text: 'text-ventazo-950 group-hover:text-ventazo-800',
    glow: 'bg-ventazo-500/30 group-hover:bg-ventazo-400/40',
  },
  minimal: {
